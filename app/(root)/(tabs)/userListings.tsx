            ...
            <ScrollView>
                ...
                {data && data.listings && data.listings.length > 0 ? (
                    data.listings.map((listing: any) => (
                        <View key={listing.listing_id} className="flex flex-row py-4 border-t-[1px] border-neutral-300">
                            {/* Image */}
                            ...
                            <View className="flex-1">
                                ...
                                <View className={`self-start rounded-md border ${statusStyles(listing.status).view} px-2 py-1`}>
                                    <Text className={`text-xs font-PoppinsMedium ${statusStyles(listing.status).text}`}>
